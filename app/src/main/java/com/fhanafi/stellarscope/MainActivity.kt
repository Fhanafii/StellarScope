...
fun WelcomeScreen(
    ...
    Box(
        ...
        Column(
            ...
            Spacer(modifier = Modifier.weight(0.05f)) // Smaller spacer to push content slightly down
            ...
            Column(
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.bodyLarge.copy(
                        fontFamily = FontFamily(Font(R.font.space_grotesklight))
                    ),
            ...
            Button(
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.labelLarge.copy(
                        fontFamily = FontFamily(Font(R.font.space_groteskmedium))
                    ),
                    color = Color.White
                )
            }
